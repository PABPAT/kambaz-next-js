...
section headings is usually larger and bolder than the plain text and their subsection 
...
white gap between the paragraph above and this paragraph, 
by default browsers render them as one contiguous piece of text 
...
tag to tell browsers to render the gaps.
            ...
            <div id="wd-lists">
                ...
                <ol id="wd-my-favourite-recipe">
                    <li>Follow above 1 to 7 steps and then 
                    below steps to enhance your taste buds!</li>
                    <li>Add 50 gms of Strawberry</li>
                    <li>Add 40 gms of Blueberries</li>
                    <li>Add 25gms of Dry Fruits</li>
                    <li>Add Apple Syrup as required</li>
                    <li>Serve and enjoy the enhanced flavour of the receipe.</li> 
                </ol>
            ...
            <div id="wd-forms">
                ...
                <form id="wd-text-fields">
                    ...
                    <button 
                        type="button"
                        onClick = {() => "alert('Life is Good!')"} //button not working
                        id="wd-all-good">
                        Hello World!
                    </button>
